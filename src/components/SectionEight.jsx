...
const SectionEight = () => {
  return (
    <div className="pt-12 px-4 flex justify-center items-center mt-24">
      ...
      <div className="w-full max-w-6xl flex flex-col xl:flex-row bg-[#EFF7F7] rounded-xl border-[1px] border-[#FBE9DF] overflow-hidden">
        {/* Left/Text Side */}
        <div className="xl:w-1/2 flex flex-col justify-center p-8">
          <p className="px-4 py-1 mb-6 bg-white text-sm text-[#94857B] font-bold rounded-[30px] w-max">
            EGG DONATION
          </p>
          <h1 className="text-3xl md:text-5xl font-custom mb-4">
        ...
        <div className="xl:w-1/2">
          <img
            src={imageGift}
            alt="image-gift"
            className="object-cover w-full h-auto md:h-[500px] lg:h-[500px]"
          />
        </div>
      </div>
    </div>
